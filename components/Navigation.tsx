...
import { Home, Calendar, SpadeIcon as Spa, Leaf, MapPin } from "lucide-react"
import { motion } from "framer-motion"

const navItems = [
  { href: "/", icon: Home, label: "Home" },
  { href: "/events", icon: Calendar, label: "Events" },
  { href: "/wellness-classes", icon: Spa, label: "Classes" },
  { href: "/wellness-resources", icon: Leaf, label: "Resources" },
  { href: "/venue", icon: MapPin, label: "Book Space" },
]
