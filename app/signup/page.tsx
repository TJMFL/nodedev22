...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 dark-gradient-bg">
      <motion.div
      ...
      >
        <Card className="glass-effect">
          <CardHeader>
            ...
            <CardTitle className="text-2xl font-bold text-center">Join THE NODE</CardTitle>
            <CardDescription className="text-center">Create your account to connect with our community</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p id="password-requirements" className="text-sm text-muted-foreground">
                  Password must be at least 8 characters long, include uppercase and lowercase letters, a number, and a
                  special character.
                </p>
              </div>
